...
/*
  Generated class for the Refereescoreboardwinby1 page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-refereescoreboardwinby1',
  templateUrl: 'refereescoreboardwinby1.html',
   providers:[PickleBallservices]
})
export class Refereescoreboardwinby1Page {
 ...
 scoresobj:any={};
  ...
  constructor(public navCtrl: NavController,public service:PickleBallservices, public navParams: NavParams,public storage: Storage, public alertCtrl: AlertController,public Modal:ModalController) {
  }
  	...
  	ionViewDidLoad(){
		...
		if(this.navParams.data.FirstServe!=undefined){
			...
			// this.TeamAScore=this.navParams.data.TeamAScore;
			// this.TeamBScore=this.navParams.data.TeamBScore;
		}
	...
	MatchStart(){
		...
		// this.navParams.data.TeamBScore=this.TeamBScore;
